...
function genAnswer() {
    answers_obj = {
        'The Legend of Zelda' : ['FYSON', 'FADO', 'NAVI', 'LANAYRU', 'MEDLI', 'EMBER', 'BEEDLE', 'KAMO', 'ELMA', 'BYRNE', 'INGO', 'OOLO', 'KARANE', 'DEMISE', 'MIKAU', 'MEESHY', 'SALVATORE', 'BIPIN', 'GOSELLE', 'MILA', 'MAMAMUYAN', 'KOBOLI', 'DARMANI', 'KOSI', 'SONIA', 'ROWN', 'CROO', 'DEKUSCRUB', 'CRAZYTRACY', 'DIMITRI', 'MINENCO', 'MAKO', 'AGITHA', 'JELLYF', 'BAZZ', 'MEDIGORON', 'GARRICKSON', 'TULIN', 'MISA', 'MALLARA', 'ANSON', 'WRYNA', 'NAPPIN', 'MISKO', 'RAURU', 'BARNES', 'OOCCOO', 'PEATRICE', 'GHIRAHIM', 'ADULTLINK', 'MALO', 'TOTT', 'GOREBIZO', 'BAITO', 'MALLADUS', 'BULIARA', 'SILVA', 'JOEL', 'GANON', 'DEKULINK', 'BASHT', 'ZANC', 'CAROCK', 'GROG', 'IRCH', 'GULD', 'HYLIA', 'MUTOH', 'ZILL', 'IMPA', 'JOANNA', 'DORIAN', 'MAGGIE', 'AGAHNIM', 'OBLI', 'SIDON', 'ELDIN', 'GORTRAM', 'YERBAL', 'KOMALI', 'BATREAUX', 'FAIRY', 'KIIMO', 'FOURGIANTS', 'DARKNUT', 'MARIN', 'ASHEI', 'WILLI', 'LOOT', 'BIGGORON', 'JAMBO', 'JOSHA', 'LARUTO', 'TYTO', 'PLATS', 'OLIFF', 'MESA', 'KONORA', 'RIJU', 'DEADHAND', 'TINGLE', 'POTOVA', 'ORCA', 'COPPORA', 'GONGORON', 'BIGOCTO', 'KOTAKE', 'ALFONZO', 'ANTON', 'DANGORO', 'ANGLERFISH', 'BELLUM', 'KAPSON', 'ORIELLE', 'KINGRAURU', 'CIELA', 'KANE', 'PIPIT', 'EAGUS', 'MISSY', 'FLEDGE', 'COBAL', 'KEET', 'MINERU', 'HINOX', 'JABUN', 'OAKIN', 'RUPIN', 'DARKLINK', 'MAPLE', 'GONZO', 'PASHLI', 'DEATHSWORD', 'PUMM', 'TWINROVA', 'GANONDORF', 'DOVOS', 'MAKAR', 'CAWLIN', 'LANA', 'DRONA', 'BURMANO', 'DARBUS', 'NIKO', 'AURU', 'MIDNA', 'TOBY', 'LADYMAUD', 'BEANSELLER', 'NACKLE', 'AVEIL', 'MAKUTREE', 'CARPENTERS', 'VALOO', 'KNUCKLE', 'ROSE', 'PIPER', 'PARELLA', 'LINK', 'DAMPA', 'GILLIAN', 'PHOENI', 'BLOSSOM', 'CADO', 'ERLA', 'COLIN', 'GONDO', 'CANDY', 'OWLAN', 'KILTON', 'ADDISON', 'KINGGUSTAF', 'KAFEI', 'PEATER', 'MANNY', 'MALANYA', 'ILIA', 'STRICH', 'FLESI', 'MIDO', 'SPARROT', 'PONNICK', 'CARLOV', 'NUDGE', 'EPONA', 'NABOORU', 'DAMPE', 'GUMMY', 'GREBA', 'TUBERT', 'ERROR', 'LEDD', 'IRENE', 'ZEPHOS', 'GORKO', 'MALON', 'FARON', 'KOLTIN', 'JAKAMAR', 'HOSKIT', 'HUDSON', 'LINKLE', 'HOLLO', 'LINDA', 'PARROW', 'MOOSH', 'DEKUKING', 'GORCORON', 'ZELDA', 'MOON', 'KORTZ', 'BORVILLE', 'GULLY', 'OLIVIO', 'NAMALI', 'SENZA', 'DIN', 'ONOX', 'QUILL', 'LINDER', 'KOUME', 'FISHMEN', 'HARTH', 'GRAMPS', 'DINOLFOS', 'GREYSON', 'MASTRO', 'STURGEON', 'KARSH', 'DODOH', 'HORG', 'GREATFAIRY', 'BERTIE', 'HUCK', 'HESTU', 'AMALI', 'GOSSACK', 'NAYRU', 'FARORE', 'ZUKO', 'LEVIAS', 'KOGOLI', 'PIGS', 'RUSTA', 'GAEPORA', 'KUKIEL', 'ANKLE', 'BRONZI', 'KINA', 'KASS', 'KREEB', 'OCTAVO', 'ORDONA', 'CYCLOS', 'HENYA', 'ODOLWA', 'ANJU', 'DARUK', 'WORTSWORTH', 'GORIYA', 'ARYLL', 'PENN', 'BUCHA', 'HORWELL', 'DARUNIA', 'YONA', 'MERCO', 'OLDMAN', 'FYER', 'MACHI', 'YUNOBO', 'KINGDALTUS', 'ASTOR', 'GROOSE', 'LOPSA', 'GULLEY', 'BARKLE', 'GOLO', 'ALDO', 'JANKA', 'DEKUBUTLER', 'LINEBECK', 'TETRA', 'ILARI', 'DEON', 'EZLO', 'GADDISON', 'OFFRAK'],
        ...
        'Mario' : ['DRYBONES', 'TOADETTE', 'KINGBOO', 'FLUZZARD', 'CATMARIO', 'DRMARIO', 'KAMEK', 'FUZZY', 'DOLPHIN', 'CZARDRAGON', 'BOOKEND', 'AIRNAPSE', 'BLUEGOOMBA', 'CATTOAD', 'FRYGUY', 'CHAD', 'CHETRIPPO', 'BORP', 'BOOSTER', 'WART', 'JUNKER', 'JABBI', 'BOOMBOOM', 'ELVINGADD', 'BABYBOWSER', 'BRISTLE', 'BROODALS', 'BAHAMUT', 'BOWSER', 'CHRIS', 'BETH', 'GARY', 'FROSTY', 'FLIFIT', 'BIGMASSIF', 'HIDERS', 'CHUBOOMBA', 'COCONUTTER', 'PIANTAS', 'JELLYBEAM', 'DONPIANTA', 'CARRIE', 'CUDGE', 'GOOMBEETLE', 'CACKLETTA', 'BOBBY', 'BABYWARIO', 'CLEFT', 'BRIAN', 'BOMP', 'FLUDD', 'SNIFITS', 'EMILY', 'DIXIEKONG', 'HANDFAKE', 'FRANCIS', 'GRINDER', 'GNARANTULA', 'ELMO', 'BONETAIL', 'DRYBOWSER', 'BOOMER', 'AZALEA', 'HIYOIHOI', 'BUZZ', 'BABYPEACH', 'BROGGY', 'AMANITA', 'NINJIS', 'LUIGI', 'DAISY', 'DOOPLISS', 'CATPEACH', 'BUMPTY', 'COURSEBOT', 'DORRIE', 'DEBULL', 'CLEFTOR', 'EYEROK', 'CROWBER', 'NOKIS', 'KLEPTO', 'CHUCKYA', 'BESTOVIUS', 'ALBINODINO', 'BLOOEY', 'ARANTULA', 'CAPPY', 'CROCO', 'DIDDYKONG', 'FLIT', 'BABYYOSHI', 'FLEEP', 'FURYBOWSER', 'WALUIGI', 'BIGBOO', 'BARB', 'BOBOMBS', 'CLAY', 'DAPHNE', 'DIMENTIO', 'BOMBETTE', 'GENEYUSS', 'BABYMARIO', 'BIFFATLAS', 'CHAS', 'BATADON', 'CHAUNCEY', 'DWEEZIL', 'BLARGG', 'HOTHEAD', 'FAWFUL', 'FREEZIE', 'CHAKRON', 'LAKITU', 'GEARMO', 'GREENIES', 'GOOMBA', 'GRRROL', 'DRAGGADON', 'BOOLOSSUS', 'BOWYER', 'DOTTIE', 'BONECHILL', 'WHOMPS', 'BLITTY', 'MARIO', 'FLURRY', 'BARONBRRR', 'FIGHTERFLY', 'GUSHEN', 'DODO', 'KOOPA', 'ELROY', 'WIGGLER', 'BLOOPER', 'CHAN', 'BOOTLER', 'DASHELL', 'CURT', 'DARKBOWSER', 'BANDIT', 'GUERILLA', 'ARFUR', 'RANGO', 'ANKOOPA', 'BARRY', 'GUMMIT', 'BABYDAISY', 'BABYLUIGI', 'BOGMIRE', 'YOSHI', 'WARIO', 'GOOMBAS', 'BROOZER', 'GRINGILL', 'EDGE', 'FLOMP', 'ANUBOO', 'BURNER', 'BELOME', 'BLUETOAD', 'BEEZO', 'BIRDO', 'FLAPTACK', 'AUTOBOMB', 'GALOOMBA', 'BIGGERBOO', 'GENERALGUY', 'ELDSTAR', 'PAULINE', 'BOSHI', 'CLAWGRIP', 'ROSALINA', 'CORTEZ', 'BANDYANDY', 'ELLA', 'BIGTOP', 'GIRA', 'ALEX', 'BESSIEBASS', 'CATAQUACK', 'BANKTOAD', 'FLURRIE', 'BELDAM', 'ALLIE', 'ELDEN', 'BIDDYBUD', 'DIGGA', 'DUPLIGHOST', 'GLOOMBA', 'CHIKAKO', 'FAKEBOWSER', 'TIARA', 'AXEMRED', 'CLUBBA', 'GOOMBRAT', 'BULLY', 'BRIGHTON', 'EXOR', 'TOAD'],
