...
function genAnswer() {
    answers_obj = {
        ...
        'Mario' : ['BANKTOAD', 'ELLA', 'BELOME', 'FLEEP', 'CHAD', 'DASHELL', 'TIARA', 'BIGTOP', 'DORRIE', 'DOOPLISS', 'BOOSTER', 'BOBOMBS', 'AXEMRED', 'BESTOVIUS', 'AZALEA', 'DAISY', 'BOMBETTE', 'DOLPHIN', 'YOSHI', 'BOSHI', 'PIANTAS', 'CORTEZ', 'CLAY', 'FRYGUY', 'CHETRIPPO', 'DIDDYKONG', 'BIRDO', 'BRIAN', 'SNIFITS', 'CHRIS', 'BOWSER', 'BOOMER', 'FURYBOWSER', 'BARONBRRR', 'EYEROK', 'BIGGERBOO', 'NOKIS', 'EMILY', 'CATMARIO', 'WARIO', 'EDGE', 'BABYLUIGI', 'BONECHILL', 'BOOMBOOM', 'CURT', 'BABYWARIO', 'BOBBY', 'BLOOEY', 'CROCO', 'DONPIANTA', 'BABYMARIO', 'BUZZ', 'BOGMIRE', 'WART', 'CARRIE', 'DAPHNE', 'FAKEBOWSER', 'FLURRIE', 'FLUZZARD', 'BETH', 'ALBINODINO', 'BRIGHTON', 'BANDYANDY', 'BLUETOAD', 'COURSEBOT', 'BROGGY', 'WALUIGI', 'ELROY', 'GENERALGUY', 'BARRY', 'FLIT', 'CAPPY', 'CATTOAD', 'DODO', 'BABYPEACH', 'BOWYER', 'BARB', 'ELDEN', 'BOOLOSSUS', 'ALEX', 'NINJIS', 'BAHAMUT', 'BIFFATLAS', 'FRANCIS', 'EXOR', 'BABYDAISY', 'ARFUR', 'CHAN', 'ALLIE', 'CUDGE', 'FAWFUL', 'MARIO', 'BELDAM', 'BOOTLER', 'RANGO', 'BIGBOO', 'BESSIEBASS', 'BROODALS', 'DOTTIE', 'GENEYUSS', 'ELDSTAR', 'DIMENTIO', 'BIGMASSIF', 'FROSTY', 'FLUDD', 'DIXIEKONG', 'DARKBOWSER', 'WHOMPS', 'BLITTY', 'GEARMO', 'LAKITU', 'ELMO', 'GARY', 'TOAD', 'PAULINE', 'CHAKRON', 'BLUEGOOMBA', 'BABYBOWSER', 'BONETAIL', 'ROSALINA', 'CZARDRAGON', 'DWEEZIL', 'CLEFTOR', 'GOOMBAS', 'CLAWGRIP', 'CHAUNCEY', 'CATPEACH', 'BABYYOSHI', 'CACKLETTA', 'GOOMBA', 'LUIGI', 'CHAS', 'WIGGLER', 'DRYBOWSER'],
