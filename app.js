...
function genAnswer() {
    answers_obj = {
        'Zelda' : ['LANAYRU', 'GRAMPS', 'JOSHA', 'GANONDORF', 'MIDO', 'BARNES', 'BIPIN', 'DARMANI', 'GROG', 'LARUTO', 'DINOLFOS', 'ASTOR', 'BIGOCTO', 'DARKNUT', 'FYSON', 'IRENE', 'FOURGIANTS', 'GROOSE', 'MAPLE', 'HUDSON', 'DEMISE', 'OLDMAN', 'KOTAKE', 'BEANSELLER', 'COLIN', 'CADO', 'KAFEI', 'CAROCK', 'MALANYA', 'MEDLI', 'LINK', 'BULIARA', 'FAIRY', 'ZELDA', 'KUKIEL', 'MARIN', 'KINGRAURU', 'DARUK', 'HYLIA', 'DANGORO', 'LINKLE', 'ELDIN', 'GANON', 'EZLO', 'OOCCOO', 'AURU', 'MOOSH', 'BORVILLE', 'DARUNIA', 'EPONA', 'ADULTLINK', 'BEEDLE', 'MEDIGORON', 'BIGGORON', 'FARORE', 'GORKO', 'DEATHSWORD', 'DARBUS', 'GORIYA', 'HINOX', 'KAPSON', 'AMALI', 'DEKULINK', 'MIKAU', 'ANJU', 'GULLEY', 'HARTH', 'BATREAUX', 'FARON', 'FYER', 'HESTU', 'MALLADUS', 'NAVI', 'IMPA', 'ERROR', 'CARLOV', 'GONGORON', 'MOON', 'INGO', 'GHIRAHIM', 'CIELA', 'AVEIL', 'ORDONA', 'MAMAMUYAN', 'DAMPE', 'ANGLERFISH', 'ILIA', 'BELLUM', 'ARYLL', 'GREYSON', 'LANA', 'KOUME', 'DIN', 'CARPENTERS', 'DORIAN', 'KASS', 'AGITHA', 'KILTON', 'BLOSSOM', 'MAKAR', 'ANKLE', 'BYRNE', 'AGAHNIM', 'CYCLOS', 'NAYRU', 'BARKLE', 'KOMALI', 'DEKUKING', 'DEADHAND', 'NIKO', 'DEKUSCRUB', 'CRAZYTRACY', 'KINGDALTUS', 'ASHEI', 'MINERU', 'FADO', 'ONOX', 'MUTOH', 'DEKUBUTLER', 'MAKUTREE', 'LEVIAS', 'ALFONZO', 'MIDNA', 'GREATFAIRY', 'ODOLWA', 'MALON', 'GORCORON', 'MILA', 'KINGGUSTAF', 'GOREBIZO', 'DARKLINK', 'MAGGIE', 'LINEBECK', 'NABOORU', 'OCTAVO', 'PENN', 'KOLTIN', 'LADYMAUD', 'MALO', 'DIMITRI'],
