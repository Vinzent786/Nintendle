...
function genAnswer() {
    const answers_obj = {
        ...
        'Mario' : ['FLURRIE', 'BIGTOP', 'WALUIGI', 'BOSHI', 'DORRIE', 'CATPEACH', 'BIFFATLAS', 'BOWYER', 'BABYLUIGI', 'GENERALGUY', 'BOMBETTE', 'DIMENTIO', 'ARFUR', 'BIGMASSIF', 'BARB', 'GARY', 'CURT', 'DOLPHIN', 'BONECHILL', 'BIRDO', 'BIGGERBOO', 'LUIGI', 'BOOSTER', 'DIXIEKONG', 'BOOMBOOM', 'FAWFUL', 'BOOLOSSUS', 'BETH', 'CAPPY', 'BABYPEACH', 'CHAKRON', 'DWEEZIL', 'GEARMO', 'FROSTY', 'ALBINODINO', 'CLAY', 'CATTOAD', 'CHETRIPPO', 'BANKTOAD', 'BARRY', 'BROODALS', 'DODO', 'CHAS', 'ELROY', 'BESTOVIUS', 'ROSALINA', 'EXOR', 'BESSIEBASS', 'FRYGUY', 'BONETAIL', 'ELDSTAR', 'BLITTY', 'CLEFTOR', 'DARKBOWSER', 'BELOME', 'ELLA', 'CACKLETTA', 'CROCO', 'DIDDYKONG', 'GENEYUSS', 'DOTTIE', 'CARRIE', 'AXEMRED', 'CLAWGRIP', 'ELMO', 'BAHAMUT', 'CUDGE', 'BIGBOO', 'BRIAN', 'CHAN', 'BUZZ', 'BOGMIRE', 'FLUZZARD', 'FURYBOWSER', 'CATMARIO', 'DAPHNE', 'BLOOEY', 'CZARDRAGON', 'BABYBOWSER', 'DAISY', 'BABYWARIO', 'DASHELL', 'FAKEBOWSER', 'ALLIE', 'BARONBRRR', 'COURSEBOT', 'BRIGHTON', 'BOOTLER', 'BELDAM', 'BOBBY', 'BLUEGOOMBA', 'ALEX', 'CORTEZ', 'BABYYOSHI', 'AZALEA', 'FLIT', 'WARIO', 'FRANCIS', 'EDGE', 'EMILY', 'BROGGY', 'DONPIANTA', 'CHRIS', 'MARIO', 'ELDEN', 'BABYDAISY', 'FLEEP', 'BLUETOAD', 'CHAUNCEY', 'DOOPLISS', 'CHAD', 'EYEROK', 'BABYMARIO', 'BANDYANDY', 'BOWSER', 'BOOMER'],
