...
function genAnswer() {
    answers_obj = {
        'The Legend of Zelda' : ['CADO', 'SIDON', 'HINOX', 'ADDISON', 'NACKLE', 'KAFEI', 'ZANC', 'BIGGORON', 'HUCK', 'DOVOS', 'IMPA', 'MUTOH', 'RAURU', 'GORCORON', 'FADO', 'HUDSON', 'MOON', 'SPARROT', 'PHOENI', 'JAKAMAR', 'FARON', 'MALANYA', 'HORG', 'AGITHA', 'DINOLFOS', 'SONIA', 'ELDIN', 'MAGGIE', 'GULD', 'CROO', 'PIPIT', 'TOBY', 'BIGOCTO', 'BIPIN', 'GOSELLE', 'DODOH', 'ARYLL', 'KASS', 'LANA', 'MIDO', 'KOMALI', 'INGO', 'ORIELLE', 'ANSON', 'LINEBECK', 'ANJU', 'MARIN', 'MEDIGORON', 'HORWELL', 'RIJU', 'BLOSSOM', 'BARNES', 'CIELA', 'BRONZI', 'JANKA', 'OOLO', 'FARORE', 'ANGLERFISH', 'HENYA', 'ERLA', 'JELLYF', 'MAKUTREE', 'PENN', 'GOREBIZO', 'MERCO', 'KARANE', 'PUMM', 'OLDMAN', 'ZELDA', 'DEMISE', 'KONORA', 'LARUTO', 'BEANSELLER', 'OLIFF', 'GADDISON', 'RUPIN', 'BATREAUX', 'OOCCOO', 'IRENE', 'FAIRY', 'HARTH', 'EPONA', 'YERBAL', 'MAMAMUYAN', 'MISKO', 'TUBERT', 'NAYRU', 'COLIN', 'TYTO', 'PLATS', 'BEEDLE', 'GANONDORF', 'WORTSWORTH', 'CAWLIN', 'GONDO', 'GRAMPS', 'OFFRAK', 'GREBA', 'GREATFAIRY', 'FLEDGE', 'FOURGIANTS', 'TWINROVA', 'ALFONZO', 'LEVIAS', 'KINA', 'DEKUSCRUB', 'SILVA', 'BORVILLE', 'KOUME', 'DIN', 'AGAHNIM', 'DEADHAND', 'DANGORO', 'DARBUS', 'BAZZ', 'AMALI', 'DEON', 'MEDLI', 'AURU', 'MOOSH', 'ILIA', 'HESTU', 'DEKUKING', 'MALLADUS', 'MALO', 'NABOORU', 'ERROR', 'LEDD', 'COBAL', 'KIIMO', 'KINGRAURU', 'MAPLE', 'CARLOV', 'BUCHA', 'AVEIL', 'BYRNE', 'DARMANI', 'EMBER', 'OWLAN', 'KILTON', 'MILA', 'LADYMAUD', 'NAVI', 'PARELLA', 'PIPER', 'MAKAR', 'DORIAN', 'DARKNUT', 'KARSH', 'ASHEI', 'GULLEY', 'GORIYA', 'WRYNA', 'KINGGUSTAF', 'BELLUM', 'CARPENTERS', 'GANON', 'KEET', 'RUSTA', 'PEATRICE', 'ASTOR', 'EAGUS', 'BERTIE', 'FLESI', 'LOPSA', 'GORKO', 'JOSHA', 'DARUNIA', 'GROOSE', 'DEATHSWORD', 'GAEPORA', 'HYLIA', 'CAROCK', 'ADULTLINK', 'FYER', 'OCTAVO', 'YONA', 'MACHI', 'MALON', 'NIKO', 'FYSON', 'MIKAU', 'BARKLE', 'YUNOBO', 'GROG', 'LINK', 'LANAYRU', 'JAMBO', 'DEKUBUTLER', 'BURMANO', 'GREYSON', 'NAPPIN', 'MEESHY', 'PEATER', 'KOTAKE', 'KUKIEL', 'GOLO', 'EZLO', 'GORTRAM', 'PONNICK', 'LINKLE', 'COPPORA', 'MISA', 'ANKLE', 'GONGORON', 'KOLTIN', 'GULLY', 'DAMPE', 'CRAZYTRACY', 'KOSI', 'STRICH', 'ONOX', 'ODOLWA', 'MALLARA', 'CYCLOS', 'BULIARA', 'MIDNA', 'DEKULINK', 'ORDONA', 'KORTZ', 'KAPSON', 'DIMITRI', 'GHIRAHIM', 'DARUK', 'TULIN', 'MASTRO', 'KINGDALTUS', 'PARROW', 'DARKLINK', 'MINERU'],
