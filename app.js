...
function genAnswer() {
    answers_obj = {
        'The Legend of Zelda' : ['FYSON', 'NACKLE', 'BARNES', 'GAEPORA', 'JELLYF', 'MUTOH', 'MALLADUS', 'ERROR', 'ORIELLE', 'DARUNIA', 'PHOENI', 'FADO', 'ARYLL', 'MALO', 'GULD', 'RUPIN', 'HENYA', 'GROG', 'GOREBIZO', 'KINGGUSTAF', 'MALLARA', 'MACHI', 'CARLOV', 'PUMM', 'KAFEI', 'HINOX', 'KOUME', 'MOON', 'BIPIN', 'DORIAN', 'CIELA', 'JANKA', 'KINA', 'BORVILLE', 'HARTH', 'GOSELLE', 'AGITHA', 'SPARROT', 'JOSHA', 'BATREAUX', 'GANONDORF', 'BULIARA', 'LANAYRU', 'DARMANI', 'GRAMPS', 'CAROCK', 'KUKIEL', 'PARROW', 'KINGRAURU', 'KOTAKE', 'DARBUS', 'GONGORON', 'BLOSSOM', 'LINEBECK', 'MAKAR', 'GHIRAHIM', 'ZANC', 'OOLO', 'EPONA', 'NIKO', 'KINGDALTUS', 'BUCHA', 'CADO', 'MAMAMUYAN', 'FARORE', 'GORKO', 'BIGGORON', 'ASHEI', 'IMPA', 'DODOH', 'GANON', 'PIPIT', 'LANA', 'OWLAN', 'FOURGIANTS', 'GORIYA', 'ANJU', 'ANGLERFISH', 'DEADHAND', 'STRICH', 'DEKUSCRUB', 'WRYNA', 'PARELLA', 'HUDSON', 'ORDONA', 'GROOSE', 'GORTRAM', 'FYER', 'DIN', 'CYCLOS', 'MEDIGORON', 'MIDO', 'DOVOS', 'OOCCOO', 'ADULTLINK', 'PLATS', 'DEATHSWORD', 'GOLO', 'FLEDGE', 'PEATER', 'BIGOCTO', 'KOLTIN', 'MEDLI', 'AVEIL', 'ELDIN', 'DEMISE', 'HORG', 'LADYMAUD', 'JAKAMAR', 'GREATFAIRY', 'MINERU', 'PEATRICE', 'FARON', 'COLIN', 'RUSTA', 'GREYSON', 'LEVIAS', 'MAPLE', 'DEKULINK', 'KOMALI', 'DARKLINK', 'PIPER', 'DINOLFOS', 'FAIRY', 'EZLO', 'MIKAU', 'DARKNUT', 'TUBERT', 'LOPSA', 'AMALI', 'SILVA', 'HYLIA', 'BELLUM', 'BYRNE', 'GULLEY', 'MALON', 'TYTO', 'ASTOR', 'IRENE', 'KILTON', 'GREBA', 'MIDNA', 'KORTZ', 'BEEDLE', 'HORWELL', 'CROO', 'GULLY', 'AGAHNIM', 'EAGUS', 'OCTAVO', 'COBAL', 'KASS', 'LARUTO', 'MOOSH', 'MARIN', 'ANKLE', 'MILA', 'KARANE', 'TOBY', 'ERLA', 'OLDMAN', 'DAMPE', 'MAKUTREE', 'MERCO', 'INGO', 'BRONZI', 'DARUK', 'NAVI', 'MAGGIE', 'ONOX', 'NAYRU', 'YERBAL', 'CRAZYTRACY', 'ILIA', 'DEKUBUTLER', 'KAPSON', 'LEDD', 'LINKLE', 'LINK', 'HESTU', 'BERTIE', 'GONDO', 'CARPENTERS', 'BEANSELLER', 'KEET', 'PENN', 'DEKUKING', 'DANGORO', 'CAWLIN', 'ALFONZO', 'AURU', 'DIMITRI', 'ODOLWA', 'NABOORU', 'MALANYA', 'BARKLE', 'GORCORON', 'ZELDA'],
